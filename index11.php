...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Manga Color Reciclado</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/bobina5.jpg" width="195" height="100" />
                        <h5>26 pulg. </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/manga-reciclado/reciclado31.jpg" width="195" height="100" />
                        <h5>31 pulg. </h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/manga3.jpg" width="195" height="100" />
                        <h5>40 pulg.</h5>
                    </div>
                    <div class="product" id="product_3">
                        <img src="carrousel-html-portafolio/gallery/manga-reciclado/re.PNG" width="195" height="100" />
                        <h5>60 pulg. </h5>

                    </div>
                    <div class="product" id="product_4">
                        <img src="carrousel-html-portafolio/gallery/manga-reciclado/reciclado1111.jpg" width="195" height="100" />
                        <h5>80 pulg</h5>
                    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>Negro,Azul,Rojo,Amarillo,Blanco,Marron,Naranja,Celeste</p>
