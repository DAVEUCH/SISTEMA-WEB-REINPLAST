...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Manga Cristal Virgen</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/manga-cristal virgen/manga-virgen26.jpg" width="195" height="100" />
                        <h5>26 pulg. </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/manga-cristal virgen/manga-virgen31.jpg" width="195" height="100" />
                        <h5>31 pulg. </h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/manga-cristal virgen/manga-virgen40.jpg" width="195" height="100" />
                        <h5>40 pulg.</h5>
                    </div>
                    <div class="product" id="product_3">
                        <img src="carrousel-html-portafolio/gallery/manga-cristal virgen/manga-virgen1.jpg" width="195" height="100" />
                        <h5>60 pulg. </h5>

                    </div>
                    <div class="product" id="product_4">
                        <img src="carrousel-html-portafolio/gallery/manga-cristal virgen/manga-virgen801.jpg" width="195" height="100" />
                        <h5>80 pulg. </h5>
                    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>En R1 y R2 de 2 micras, 3 micras, 4 micras, 5 micras, 6 micras, 7 micras, 8 micras y 9 micras. Proteccion UV.</p>
