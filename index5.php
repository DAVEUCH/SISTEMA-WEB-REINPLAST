...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Bolsa 180 Litros</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/bolsa-amarillo/bolsa9.jpg" width="195" height="100" />
                        <h5>AMARILLO </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/bolsa-azul/bolsa2.jpg" width="195" height="100" />
                        <h5>AZUL</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-blanco/bolsa9.jpg" width="195" height="100" />
                        <h5>BLANCO</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-marron/bolsa6.jpg" width="195" height="100" />
                        <h5>MARRON</h5>
                    </div>
                     <div class="product" id="product_2">
                     ...
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-rojo/bolsa2.jpg" width="195" height="100" />
                        <h5>ROJO</h5>
                    </div>
                     <div class="product" id="product_2">
