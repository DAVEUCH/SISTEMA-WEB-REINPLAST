...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Mangas Azul</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/manga-azul/bobina31.jpg" width="195" height="100" />
                        <h5>26 pulg </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/manga-azul/manga20.jpg" width="195" height="100" />
                        <h5>31 pulg. </h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/manga-azul/manga40.jpg" width="195" height="100" />
                        <h5>40 pulg.</h5>
                    </div>
                    <div class="product" id="product_3">
                        <img src="carrousel-html-portafolio/gallery/manga-azul/manga80.jpg" width="195" height="100" />
                        <h5>60 pulg.</h5>

                    </div>
                    <div class="product" id="product_4">
                        <img src="carrousel-html-portafolio/gallery/manga-azul/manga601.jpg" width="195" height="100" />
                        <h5>80 pulg.</h5>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>2 micras, 3 micras, 4 micras, 5 micras, 6 micras, 7 micras, 8 micras y 9 micras. Proteccion UV.</p>
            <h5 class="card-title"> Medidas:</h5>
            <p>26, 31, 40, 60, 80 Plg  1m, 1.2m, 1.5m, 2m, 2.5m y 3m (Margarito).</p>
            <h5 class="card-title"> Pesos de la bobina:</h5>
            <p> Desde 20 Kg hacia Arriba segun la eleccion del Cliente. Se realiza Producciones especiales y personalizadas Segun el Requerimiento del Cliente.</p>
