...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Bolsa 220 Litros</a></li>
        ...
        <div id="content" class="col-lg-12">
            <div id="carrusel">
                ...
                <div class="carrusel">
                        ...
                        <img src="carrousel-html-portafolio/gallery/bolsa-amarillo/bolsa3.jpg" width="195" height="100" />
                        <h5>AMARILLO </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/bolsa-azul/bolsa3.jpg" width="195" height="100" />
                        <h5>AZUL</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-blanco/bolsa7.jpg" width="195" height="100" />
                        <h5>BLANCO</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-marron/bolsa2.jpg" width="195" height="100" />
                        <h5>MARRON</h5>
                    </div>
                     <div class="product" id="product_2">
                     ...
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-rojo/bolsa7.jpg" width="195" height="100" />
                        <h5>ROJO</h5>
                    </div>
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-verde/bolsa4.jpg" width="195" height="100" />
                        <h5>VERDE</h5>
                    </div>
                </div>
            </div>
