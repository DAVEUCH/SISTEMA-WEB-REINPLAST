...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("reinplastproy@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "reinplastproy@gmail.com";  // Correo Electrónico
    $mail->Password = "dave3491533"; // Contraseña
