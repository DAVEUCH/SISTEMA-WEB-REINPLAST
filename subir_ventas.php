...
<div class="social-bar">
 ...
 <header>
        ...
        <h1 class="text-center">Lista de documentos de Venta subidos en el sistema</h1>
  ...
  <div class="row">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <div class="col-lg-6">
          <form method="POST" action="CargarFicherosVentas.php" enctype="multipart/form-data">
...
<table class="table">
  ...
  <tbody>
<?php
$archivos = scandir("subidas_ventas");
$num=0;
...
<p>  
    ...
    <tr>
      ...
      <td><a title="Descargar Archivo" href="subidas_ventas/<?php echo $archivos[$i]; ?>" download="<?php echo $archivos[$i]; ?>" style="color: blue; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a></td>
      <td><a title="Eliminar Archivo" href="EliminarFicheroVentas.php?name=subidas_ventas/<?php echo $archivos[$i]; ?>" style="color: red; font-size:18px;" onclick="return confirm('Esta seguro de eliminar el archivo?');"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a></td>
    </tr>
 <?php }?> 
