...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Manga Blanco R1</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/manga-blanco/manga26.jpg" width="195" height="100" />
                        <h5>26 pulg. </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/manga-blanco/manga311.jpg" width="195" height="100" />
                        <h5>31 pulg. </h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/manga-blanco/manga40.jpg" width="195" height="100" />
                        <h5>40 pulg.</h5>
                    </div>
                    <div class="product" id="product_3">
                        <img src="carrousel-html-portafolio/gallery/manga-blanco/manga601.png" width="195" height="100" />
                        <h5>60 pulg. </h5>

                    </div>
                    <div class="product" id="product_4">
                        <img src="carrousel-html-portafolio/gallery/manga-blanco/802.png" width="195" height="100" />
                        <h5>80 pulg. </h5>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>26, 31, 40, 60, 80 Plg. 1m, 1.2m, 1.5m, 2m, 2.5m y 3m (Margarito) medidas especiales de acuerdo a su necesidad.</p>
