...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Bolsa 140 Litros</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                   <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/bolsa-amarillo/bolsa8.jpg" width="195" height="100" />
                        <h5>AMARILLO </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/bolsa-azul/bolsa9.jpg" width="195" height="100" />
                        <h5>AZUL</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-blanco/bolsa8.jpeg" width="195" height="100" />
                        <h5>BLANCO</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-marron/bolsa12.jpg" width="195" height="100" />
                        <h5>MARRON</h5>
                    </div>
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-negro/bolsa4.jpg" width="195" height="100" />
                        <h5>NEGRO</h5>
                    </div>
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-rojo/bolsa10.jpg" width="195" height="100" />
                        <h5>ROJO</h5>
                    </div>
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-verde/bolsa3.jpg" width="195" height="100" />
                        <h5>VERDE</h5>
                    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h7 class="card-title"> Color:</h7>
            <p>Negro,Azul,Rojo,Amarillo,Blanco,Marron</p>
            <h7 class="card-title"> Medidas:</h7>
            <p>35 x 42 Plg.</p>
            <h7 class="card-title"> Cantidad:</h7>
