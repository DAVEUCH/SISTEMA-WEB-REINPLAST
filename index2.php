...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Bolsa 50 Litros</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    ...
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/bolsa-azul/bolsa7.jpg" width="195" height="100" />
                        <h5>AZUL</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-blanco/bolsa4.jpg" width="195" height="100" />
                        <h5>BLANCO</h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-marron/bolsa11.jpg" width="195" height="100" />
                        <h5>MARRON</h5>
                    </div>
                     <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/bolsa-negro/bolsa10.jpeg" width="195" height="100" />
                        <h5>NEGRO</h5>
                    </div>
                     <div class="product" id="product_2">
