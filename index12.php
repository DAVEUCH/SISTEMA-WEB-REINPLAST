...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           <li class="breadcrumb-item">Manga Negro</a></li>
            ...
            <div id="carrusel">
                ...
                <div class="carrusel">
                    <div class="product" id="product_0">
                        <img src="carrousel-html-portafolio/gallery/manga-negro/manga26.png" width="195" height="100" />
                        <h5>26 pulg. </h5>
                    </div>
                    <div class="product" id="product_1">
                        <img src="carrousel-html-portafolio/gallery/manga-negro/manga31.jpg" width="195" height="100" />
                        <h5>31 pulg. </h5>
                    </div>
                    <div class="product" id="product_2">
                        <img src="carrousel-html-portafolio/gallery/manga-negro/manga40.jpg" width="195" height="100" />
                        <h5>40 pulg.</h5>
                    </div>
                    <div class="product" id="product_3">
                        <img src="carrousel-html-portafolio/gallery/manga-negro/manga-negro60.jpg" width="195" height="100" />
                        <h5>60 pulg. </h5>

                    </div>
                    <div class="product" id="product_4">
                        <img src="carrousel-html-portafolio/gallery/manga-negro/manga80.jpg" width="195" height="100" />
                        <h5>80 pulg</h5>
                    </div>
                    <div class="product" id="product_5">
                        <img src="carrousel-html-portafolio/gallery/bolsaport6.jpg" width="195" height="100" />
